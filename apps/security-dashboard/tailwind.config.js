  ...
  theme: {
    extend: {
      colors: {
        ...
        security: {
          // Primary brand colors for security context
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
          300: '#93c5fd',
        ...
        critical: {
          // For critical alerts and high-severity issues
          50: '#fef2f2',
          100: '#fee2e2',
          200: '#fecaca',
          300: '#fca5a5',
        ...
        success: {
          // For resolved issues and healthy states
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
          300: '#86efac',
        ...
        // SOC-specific background colors
        soc: {
          background: '#0a0f1c',
          surface: '#111827',
          elevated: '#1f2937',
      ...
      boxShadow: {
        ...
        'critical-glow': '0 0 15px rgba(239, 68, 68, 0.5)',
        'warning-glow': '0 0 15px rgba(245, 158, 11, 0.5)',
        'success-glow': '0 0 15px rgba(34, 197, 94, 0.5)',
      },
      backdropBlur: {
        xs: '2px',
      },
