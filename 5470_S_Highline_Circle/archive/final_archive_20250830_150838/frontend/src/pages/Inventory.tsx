...
export default function Inventory() {
  ...
  const updateItemMutation = useMutation({
    mutationFn: (item: Partial<Item> & { id: string }) => {
      console.log('Inventory updateItemMutation called with:', item);
      return api.updateItem(item.id, item);
    },
    onSuccess: (data, variables) => {
      console.log('Inventory update successful:', data, 'for item:', variables);
      queryClient.invalidateQueries({ queryKey: ['items'] });
      toast.success('Item updated successfully');
    },
    onError: (error, variables) => {
      console.error('Inventory update failed:', error, 'for item:', variables);
