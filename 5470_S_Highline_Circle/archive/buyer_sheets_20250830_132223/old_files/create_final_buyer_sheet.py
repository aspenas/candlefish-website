#!/usr/bin/env python3
"""
Create final buyer sheet with all confirmed items including outdoor additions
"""
...
room_order = [
    ...
    "Outdoor Nook Patio",
    # Whole Property
    "Whole Property (Plants)", "Outdoor/B Gardening"
]
...
# Save to file
with open('final_buyer_sheet_complete.txt', 'w') as f:
    f.write(f"5470 S HIGHLINE CIRCLE - BUYER SHEET\n")
    f.write(f"Generated: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n")
    f.write(f"Total Value: ${grand_total:,.2f}\n")
