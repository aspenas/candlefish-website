...
export function ChartCard({ title, subtitle, data, dataKey, unit, height = 260 }:{ title: string; subtitle?: string; data: any[]; dataKey: string; unit?: '%' | 'money'; height?: number; }) {
  return (
    <div className="bg-white rounded-[var(--mad-radius-xl)] shadow-[var(--mad-shadow-soft)] border border-black/5 p-5">
      ...
      <div style={{ height }}>
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 12, right: 12, bottom: 12, left: 12 }}>
            ...
            <Bar dataKey={dataKey} fill="var(--mad-bronze)">
