...
export const workshopNotes: WorkshopNote[] = [
  {
    id: 'paradox-of-enhancement',
    date: '2025.09.01',
    category: 'philosophical',
    projectContext: 'Live R&D Infrastructure',
    title: 'The Paradox of Enhancement',
    excerpt: 'Today\'s revelation arrived through rejection. While evaluating an "enhanced" prompt framework for Claude\'s 1M context window, I discovered something profound: the best enhancement is often knowing when not to enhance.',
    readTime: '16 min read',
    hasCode: true,
    hasVisualization: false,
    tags: ['enhancement-paradox', 'prompt-frameworks', 'claude-1m-context', 'live-r&d', 'operational-intelligence', 'systems-thinking', 'cognitive-load', 'simplicity-principle'],
    content: `
...
*End of current notes. More patterns discovered weekly.*
  ...
  },
  {
    ...
    date: '2025.09.05',
    category: 'philosophical',
    projectContext: 'Operational Philosophy',
...
*Filed Under: Operational Philosophy / Competitive Advantage / Performance Art*
  ...
  {
    id: 'the-hygiene-paradox',
    date: '2025.08.26',
    category: 'philosophical',
    projectContext: 'Pattern Study',
    title: 'The Hygiene Paradox',
    excerpt: 'The most transformative work leaves no visible trace. We spent a month deleting code, removing secrets, adding friction. The codebase got smaller. The workflows got slower. Everything got better.',
